import 'dart:async';
import 'package:berlin_service_portal/widgets/cards/mock_card_data.dart';
import 'package:berlin_service_portal/widgets/featured_grid.dart';
  ...
  Widget build(BuildContext context) {
    final content = Padding(
      ...
      child: Column(
        ...
        children: const [
          SizedBox(height: 12),
          FeaturedGrid(items: kMockCards), // занимает всю ширину контента
          SizedBox(height: 24),
        ],
      ),
    );

    if (_hasAncestorScroll) {
      return content;
    } else {
